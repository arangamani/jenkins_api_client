...
# -*- encoding: utf-8 -*-
# stub: jenkins_api_client 0.15.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/jenkins_api_client/multijob.rb",
    ...
    "spec/unit_tests/fixtures/files/multijob_sample.xml",
    "spec/unit_tests/fixtures/files/updatable_plugins.json",
    "spec/unit_tests/job_spec.rb",
    "spec/unit_tests/multijob_spec.rb",
